 ...
 * que seu melhor e pior desempenho. Dada uma lista string: 
 * “pontuação1 pontuação2 pontuação3 etc..”, escreva uma função que ao recebê-la
 * irá comparar os valores um a um e irá retornar um vetor com o número de vezes
 * que ele bateu seu recorde de maior número de pontos e quando fez seu pior
